            ...
            return (
                <TableRow key={message.id}>
                    ...
                    <TableCell align="left">
                        {message?.category?.shortcode || message?.isCategory ? <Chip className={classes.backgroundDark} label={message?.category?.shortcode} variant="outlined" /> : 'Sem menu vinculada'}
                    </TableCell>
                    { !readOnly ? (
